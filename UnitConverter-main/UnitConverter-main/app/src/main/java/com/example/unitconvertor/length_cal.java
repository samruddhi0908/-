...
public class length_cal extends AppCompatActivity {
        ...
        cv_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (tempInput.equals("") || tempInput == null) {
                    Toast.makeText(length_cal.this, "Wrong Input Type", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(length_cal.this, "SUCCESS", Toast.LENGTH_SHORT).show();
    ...
    private String newtonToFahrenheit(double newton) {
        double fahrenheit = newton * 10;
        return String.valueOf(fahrenheit);
    }

    private String newtonToKelvin(double newton) {
        double kelvin = newton * 100;
        return String.valueOf(kelvin);
    }
